var _ = require("underscore"),
	...
	Strategy = require("passport-earthmaps").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/earthmaps/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('earthmaps', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('earthmaps', arguments[0]);
		}
	},
